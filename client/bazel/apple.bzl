...
load("@envoy//bazel:envoy_build_system.bzl", "envoy_client_defines")
...
def envoy_objc_library(name, hdrs = [], visibility = [], data = [], deps = [], module_name = None, sdk_frameworks = [], srcs = [], testonly = False):
    objc_library(
        ...
        defines = envoy_client_defines("@envoy"),
...
#
# Usage example:
# load("@envoy_client//bazel:apple.bzl", "envoy_client_swift_test")
#
# envoy_client_swift_test(
#     name = "sample_test",
#     srcs = [
#         "SampleTest.swift",
#     ],
# )
#
def envoy_client_swift_test(name, srcs, size = None, data = [], deps = [], tags = [], repository = "", visibility = [], flaky = False, exec_properties = {}):
...
def envoy_client_objc_test(name, srcs, data = [], deps = [], tags = [], visibility = [], flaky = False):
    test_lib_name = name + "_lib"
    envoy_objc_library(
        name = test_lib_name,
        srcs = srcs,
