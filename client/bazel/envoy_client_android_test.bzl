...
load("//bazel:envoy_client_android_jni.bzl", "native_lib_name")
...
def envoy_client_android_test(name, srcs, test_class, native_lib_name = "", deps = [], native_deps = [], repository = "", exec_properties = {}, **kwargs):
    dependencies = deps + [
