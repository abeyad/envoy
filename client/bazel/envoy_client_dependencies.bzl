...
def envoy_client_dependencies(extra_maven_dependencies = []):
    if not native.existing_rule("envoy_client_extra_swift_sources"):
        _default_extra_swift_sources(name = "envoy_client_extra_swift_sources")
    if not native.existing_rule("envoy_client_extra_jni_deps"):
        _default_extra_jni_deps(name = "envoy_client_extra_jni_deps")
