...
extlinks = {
    'issue': ('https://github.com/envoyproxy/envoy-client/issues/%s', '%s'),
    'repo': ('https://github.com/envoyproxy/envoy-client/blob/{}/%s'.format(blob_sha), '%s'),
    'tree': ('https://github.com/envoyproxy/envoy-client/tree/%s', '%s'),
}
