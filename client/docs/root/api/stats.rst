...
Pulse is Envoy Client's stats library, used for capturing client application time series
...
This library (like all of Envoy Client) is under active development.

To leverage Pulse, obtain an instance of a ``PulseClient`` from an Envoy Client ``Engine``
