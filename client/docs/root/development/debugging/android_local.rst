...
- As a developer you can compile your `envoy-client` repository and the generated `.aar` will be automatically recognized by Android Studio
- `envoy-client` can be compiled to a single arch for debugging
...
Adding Envoy-Client Project into Android Studio
-----------------------------------------------
