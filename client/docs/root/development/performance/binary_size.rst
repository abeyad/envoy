...
the Envoy Client team has standardized the process in this document.
...
<https://github.com/envoyproxy/envoy-client/labels/perf%2Fsize>`_. After performing
...
When compiling Envoy Client for ``arm64`` only, we found the final size to be
**approximately 4.6 MB** as of :tree:`v0.2.3.03062020 <v0.2.3.03062020>`.

This analysis was done by:

- Compiling the `analysis variant example app <https://github.com/rebello95/EnvoyClientAnalysis/tree/v0.2.3.03062020/AnalysisVariant>`_ for release
...
- Doing the same for the `analysis control example app <https://github.com/rebello95/EnvoyClientAnalysis/tree/v0.2.3.03062020/AnalysisControl>`_ in that repository, and comparing the size differences
