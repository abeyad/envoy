...
Envoy Client currently handles switching preferred networks between wifi/cellular based on
...
``bazel client-install //examples/kotlin/hello_world:hello_envoy_kt --fat_apk_cpu=armeabi-v7a``
...
`perf/device label <https://github.com/envoyproxy/envoy-client/labels/perf%2Fdevice>`_.
