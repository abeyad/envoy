...
The following workflow should be followed to create and publish a new Envoy Client
`release <https://github.com/envoyproxy/envoy-client/releases>`_.
...
`tagged <https://github.com/envoyproxy/envoy-client/releases>`_.
...
- Publishes the most recent version of the Envoy Client docs
