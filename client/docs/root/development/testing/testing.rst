...
Envoy Client strives to have a high standard of code quality and test coverage for the entire
project.
...
`threshold <https://github.com/envoyproxy/envoy-client/blob/0b06697989c7d64ab73dee76744b7493ce38c28b/.github/workflows/coverage.yml#L23>`_.
