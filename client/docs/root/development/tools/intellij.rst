...
Using IntelliJ with Envoy Client
--------------------------------

To get started using IntelliJ with Envoy Client:

1. Download a supported `IntelliJ version <https://www.jetbrains.com/idea/download/other.html>`_ supported by the Bazel plugin
2. Apply local hacks to make IntelliJ work using the branch `hack-for-intellij <https://github.com/envoyproxy/envoy-client/tree/hack-for-intellij>`_
3. Open up the Envoy Client project using the Bazel import project wizard
