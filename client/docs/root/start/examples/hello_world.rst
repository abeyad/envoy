...
The "hello world" example projects start Envoy Client and use it to make network requests
...
``bazel client-install //examples/java/hello_world:hello_envoy --fat_apk_cpu=<arch1,arch2>``
...
``bazel client-install //examples/kotlin/hello_world:hello_envoy_kt --fat_apk_cpu=<arch1,arch2>``
