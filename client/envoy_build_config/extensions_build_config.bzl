...
CLIENT_PACKAGE_VISIBILITY = ["@envoy//:client_library"]
...
EXTENSIONS = {
    ...
    "envoy.filters.http.assertion":                        "@envoy_client//library/common/extensions/filters/http/assertion:config",
    "envoy.filters.http.buffer":                           "//source/extensions/filters/http/buffer:config",
    "envoy.filters.http.decompressor":                     "//source/extensions/filters/http/decompressor:config",
    "envoy.filters.http.dynamic_forward_proxy":            "//source/extensions/filters/http/dynamic_forward_proxy:config",
    "envoy.filters.http.local_error":                      "@envoy_client//library/common/extensions/filters/http/local_error:config",
    "envoy.filters.http.platform_bridge":                  "@envoy_client//library/common/extensions/filters/http/platform_bridge:config",
    "envoy.filters.http.network_configuration":            "@envoy_client//library/common/extensions/filters/http/network_configuration:config",
    "envoy.filters.http.route_cache_reset":                "@envoy_client//library/common/extensions/filters/http/route_cache_reset:config",
    ...
    "envoy.key_value.platform":                            "@envoy_client//library/common/extensions/key_value/platform:config",
    ...
    "envoy.retry.options.network_configuration":           "@envoy_client//library/common/extensions/retry/options/network_configuration:config",
    ...
    "envoy_client.cert_validator.platform_bridge_cert_validator": "@envoy_client//library/common/extensions/cert_validator/platform_bridge:config",
    "envoy.listener_manager_impl.api":                     "@envoy_client//library/common/extensions/listener_managers/api_listener_manager:api_listener_manager_lib",
    ...
    "envoy.quic.packet_writer.platform":                   "@envoy_client//library/common/extensions/quic_packet_writer/platform:config",
