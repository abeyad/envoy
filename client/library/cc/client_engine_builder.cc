...
ClientEngineBuilder::ClientEngineBuilder() {}
...
ClientEngineBuilder& ClientEngineBuilder::addConnectTimeoutSeconds(int connect_timeout_seconds) {
  connect_timeout_seconds_ = connect_timeout_seconds;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::addDnsRefreshSeconds(int dns_refresh_seconds) {
  dns_refresh_seconds_ = dns_refresh_seconds;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::addDnsMinRefreshSeconds(int dns_min_refresh_seconds) {
  dns_min_refresh_seconds_ = dns_min_refresh_seconds;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::addDnsFailureRefreshSeconds(int base, int max) {
  dns_failure_refresh_seconds_base_ = base;
  dns_failure_refresh_seconds_max_ = max;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::addDnsQueryTimeoutSeconds(int dns_query_timeout_seconds) {
  dns_query_timeout_seconds_ = dns_query_timeout_seconds;
  return *this;
}

ClientEngineBuilder&
ClientEngineBuilder::setDisableDnsRefreshOnFailure(bool disable_dns_refresh_on_failure) {
  disable_dns_refresh_on_failure_ = disable_dns_refresh_on_failure;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::setDisableDnsRefreshOnNetworkChange(
    bool disable_dns_refresh_on_network_change) {
  disable_dns_refresh_on_network_change_ = disable_dns_refresh_on_network_change;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::setDnsNumRetries(uint32_t dns_num_retries) {
  dns_num_retries_ = dns_num_retries;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::setGetaddrinfoNumThreads(uint32_t num_threads) {
  getaddrinfo_num_threads_ = num_threads;
  return *this;
}

ClientEngineBuilder&
ClientEngineBuilder::addDnsPreresolveHostnames(const std::vector<std::string>& hostnames) {
...
ClientEngineBuilder& ClientEngineBuilder::setDnsResolver(
    const envoy::config::core::v3::TypedExtensionConfig& dns_resolver_config) {
  dns_resolver_config_ = dns_resolver_config;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::setAdditionalSocketOptions(
    const std::vector<envoy::config::core::v3::SocketOption>& socket_options) {
  socket_options_ = socket_options;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::addMaxConnectionsPerHost(int max_connections_per_host) {
  max_connections_per_host_ = max_connections_per_host;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::addH2ConnectionKeepaliveIdleIntervalMilliseconds(
...
ClientEngineBuilder& ClientEngineBuilder::addH2ConnectionKeepaliveTimeoutSeconds(
...
ClientEngineBuilder& ClientEngineBuilder::setAppVersion(std::string app_version) {
  app_version_ = std::move(app_version);
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::setAppId(std::string app_id) {
  app_id_ = std::move(app_id);
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::setDeviceOs(std::string device_os) {
  device_os_ = std::move(device_os);
  return *this;
}

ClientEngineBuilder&
ClientEngineBuilder::setPerTryIdleTimeoutSeconds(int per_try_idle_timeout_seconds) {
  per_try_idle_timeout_seconds_ = per_try_idle_timeout_seconds;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::enableGzipDecompression(bool gzip_decompression_on) {
  gzip_decompression_filter_ = gzip_decompression_on;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::enableBrotliDecompression(bool brotli_decompression_on) {
  brotli_decompression_filter_ = brotli_decompression_on;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::enableSocketTagging(bool socket_tagging_on) {
  socket_tagging_filter_ = socket_tagging_on;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::enableHttp3(bool http3_on) {
  enable_http3_ = http3_on;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::enableEarlyData(bool early_data_on) {
  enable_early_data_ = early_data_on;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::enableScone(bool enable) {
  scone_enabled_ = enable;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::addQuicConnectionOption(std::string option) {
  quic_connection_options_.push_back(std::move(option));
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::addQuicClientConnectionOption(std::string option) {
  quic_client_connection_options_.push_back(std::move(option));
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::setHttp3ConnectionOptions(std::string options) {
  http3_connection_options_ = std::move(options);
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::setHttp3ClientConnectionOptions(std::string options) {
  http3_client_connection_options_ = std::move(options);
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::addQuicHint(std::string host, int port) {
  quic_hints_.emplace_back(std::move(host), port);
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::addQuicCanonicalSuffix(std::string suffix) {
  quic_suffixes_.emplace_back(std::move(suffix));
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::setNumTimeoutsToTriggerPortMigration(int num_timeouts) {
  num_timeouts_to_trigger_port_migration_ = num_timeouts;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::enableInterfaceBinding(bool interface_binding_on) {
  enable_interface_binding_ = interface_binding_on;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::setUdpSocketReceiveBufferSize(int32_t size) {
  udp_socket_receive_buffer_size_ = size;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::setUdpSocketSendBufferSize(int32_t size) {
  udp_socket_send_buffer_size_ = size;
  return *this;
}

ClientEngineBuilder&
ClientEngineBuilder::enableDrainPostDnsRefresh(bool drain_post_dns_refresh_on) {
  enable_drain_post_dns_refresh_ = drain_post_dns_refresh_on;
  return *this;
}

ClientEngineBuilder&
ClientEngineBuilder::enforceTrustChainVerification(bool trust_chain_verification_on) {
  enforce_trust_chain_verification_ = trust_chain_verification_on;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::setUpstreamTlsSni(std::string sni) {
  upstream_tls_sni_ = std::move(sni);
  return *this;
}

ClientEngineBuilder&
ClientEngineBuilder::setQuicConnectionIdleTimeoutSeconds(int quic_connection_idle_timeout_seconds) {
  quic_connection_idle_timeout_seconds_ = quic_connection_idle_timeout_seconds;
  return *this;
}

ClientEngineBuilder&
ClientEngineBuilder::setKeepAliveInitialIntervalMilliseconds(int keepalive_initial_interval_ms) {
  keepalive_initial_interval_ms_ = keepalive_initial_interval_ms;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::setMaxConcurrentStreams(int max_concurrent_streams) {
  max_concurrent_streams_ = max_concurrent_streams;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::enablePlatformCertificatesValidation(
...
ClientEngineBuilder& ClientEngineBuilder::enableDnsCache(bool dns_cache_on,
...
ClientEngineBuilder& ClientEngineBuilder::addNativeFilter(std::string name,
                                                          std::string typed_config) {
  native_filter_chain_.emplace_back(NativeFilterConfig(std::move(name), std::move(typed_config)));
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::addNativeFilter(const std::string& name,
...
#if defined(__APPLE__)
ClientEngineBuilder&
ClientEngineBuilder::enableNetworkChangeMonitor(bool network_change_monitor_on) {
  enable_network_change_monitor_ = network_change_monitor_on;
  return *this;
}
#endif

std::string ClientEngineBuilder::nativeNameToConfig(absl::string_view name) {
#ifdef ENVOY_ENABLE_FULL_PROTOS
  return absl::StrCat("[type.googleapis.com/"
                      "envoyclient.extensions.filters.http.platform_bridge.PlatformBridge] {"
                      "platform_filter_name: \"",
                      name, "\" }");
#else
  envoyclient::extensions::filters::http::platform_bridge::PlatformBridge proto_config;
  ...
  any_config.set_type_url(
      "type.googleapis.com/envoyclient.extensions.filters.http.platform_bridge.PlatformBridge");
...
ClientEngineBuilder& ClientEngineBuilder::addPlatformFilter(const std::string& name) {
  addNativeFilter("envoy.filters.http.platform_bridge", nativeNameToConfig(name));
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::enableWorkerThread(bool use_worker_thread) {
  Platform::EngineBuilderBase<ClientEngineBuilder>::enableWorkerThread(use_worker_thread);
  if (useWorkerThread()) {
...
ClientEngineBuilder&
ClientEngineBuilder::setUseQuicPlatformPacketWriter(bool use_quic_platform_packet_writer) {
  use_quic_platform_packet_writer_ = use_quic_platform_packet_writer;
  return *this;
}

ClientEngineBuilder&
ClientEngineBuilder::enableQuicConnectionMigration(bool quic_connection_migration_on) {
  enable_quic_connection_migration_ = quic_connection_migration_on;
  return *this;
}

ClientEngineBuilder&
ClientEngineBuilder::setMigrateIdleQuicConnection(bool migrate_idle_quic_connection) {
  migrate_idle_quic_connection_ = migrate_idle_quic_connection;
  return *this;
}

ClientEngineBuilder& ClientEngineBuilder::setMaxIdleTimeBeforeQuicMigrationSeconds(
...
ClientEngineBuilder&
ClientEngineBuilder::setMaxTimeOnNonDefaultNetworkSeconds(int max_time_on_non_default_network) {
  max_time_on_non_default_network_seconds_ = max_time_on_non_default_network;
  return *this;
}

#if defined(__APPLE__)
ClientEngineBuilder& ClientEngineBuilder::respectSystemProxySettings(bool value,
...
ClientEngineBuilder& ClientEngineBuilder::setIosNetworkServiceType(int ios_network_service_type) {
  ios_network_service_type_ = ios_network_service_type;
  return *this;
}
#endif

#ifdef ENVOY_CLIENT_XDS

ClientEngineBuilder& ClientEngineBuilder::setXds(XdsBuilder xds_builder) {
...
#endif // ENVOY_CLIENT_XDS

absl::Status ClientEngineBuilder::configureRouteConfig(
  ...
  route->add_request_headers_to_remove("x-envoy-client-cluster");
  route->mutable_per_request_buffer_limit_bytes()->set_value(4096);
  auto* route_to = route->mutable_route();
  route_to->set_cluster_header("x-envoy-client-cluster");
...
absl::Status ClientEngineBuilder::configureHttpFilters(
  ...
  if (socket_tagging_filter_) {
    envoyclient::extensions::filters::http::socket_tag::SocketTag tag_config;
  ...
  envoyclient::extensions::filters::http::network_configuration::NetworkConfiguration
      network_config;
  ...
  envoyclient::extensions::filters::http::local_error::LocalError local_config;
...
void ClientEngineBuilder::configureDnsCache(
  ...
  if (dns_cache_on_) {
    envoyclient::extensions::key_value::platform::PlatformKeyValueStoreConfig kv_config;
...
absl::Status ClientEngineBuilder::configureStaticClusters(
  ...
  if (platform_certificates_validation_on_) {
    envoy_client::extensions::cert_validator::platform_bridge::PlatformBridgeCertValidator
        validator;
    ...
    validation->mutable_custom_validator_config()->set_name(
        "envoy_client.cert_validator.platform_bridge_cert_validator");
    std::ignore =
...
#include "library/common/config/certificates.inc"
  ...
  if (enable_http3_) {
    ...
    if (use_quic_platform_packet_writer_ || enable_quic_connection_migration_) {
      envoy_client::extensions::quic_packet_writer::platform::QuicPlatformPacketWriterConfig
          writer_config;
      std::ignore =
...
void ClientEngineBuilder::addStatsInclusionStringMatchers() {
...
void ClientEngineBuilder::addWatchdog() {
...
absl::Status ClientEngineBuilder::configureNode(envoy::config::core::v3::Node* node) {
...
absl::Status ClientEngineBuilder::configXds(envoy::config::bootstrap::v3::Bootstrap* bootstrap) {
  (void)bootstrap;
#ifdef ENVOY_CLIENT_XDS
  if (xds_builder_) {
...
EngineSharedPtr ClientEngineBuilder::build() {
  return Platform::EngineBuilderBase<ClientEngineBuilder>::build().value();
}

void ClientEngineBuilder::preRunSetup(InternalEngine* engine) {
...
void ClientEngineBuilder::postRunSetup(Engine* engine) {
