...
EngineCommon::EngineCommon(std::shared_ptr<Envoy::OptionsImplBase> options,
  ...
  // https://github.com/envoyproxy/envoy-client/issues/831. Ignoring termination signals makes it
  // more likely that the event loop will only exit due to Engine destruction
  // https://github.com/envoyproxy/envoy-client/blob/a72a51e64543882ea05fba3c76178b5784d39cdc/library/common/engine.cc#L105.
