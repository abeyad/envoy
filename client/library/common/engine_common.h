...
// If Envoy is built with lite protos, this will register Envoy-Client specific
...
/**
 * This class is used instead of Envoy::MainCommon to customize logic for the Envoy Client setting.
