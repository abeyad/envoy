...
class LocalErrorFilterFactory
    : public Common::FactoryBase<envoyclient::extensions::filters::http::local_error::LocalError> {
public:
  LocalErrorFilterFactory() : FactoryBase("local_error") {}

private:
  ::Envoy::Http::FilterFactoryCb createFilterFactoryFromProtoTyped(
      const envoyclient::extensions::filters::http::local_error::LocalError& config,
