...
class SocketTagFilterFactory
    : public Common::FactoryBase<envoyclient::extensions::filters::http::socket_tag::SocketTag> {
public:
  SocketTagFilterFactory() : FactoryBase("socket_tag") {}

private:
  ::Envoy::Http::FilterFactoryCb createFilterFactoryFromProtoTyped(
      const envoyclient::extensions::filters::http::socket_tag::SocketTag& config,
