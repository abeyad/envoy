...
NetworkConfigurationRetryOptionsPredicate::NetworkConfigurationRetryOptionsPredicate(
    const envoyclient::extensions::retry::options::network_configuration::
...
NetworkConfigurationRetryOptionsPredicate::updateOptions(
  ...
  // present, all socket options set in Envoy Client are provided by the NetworkConnectivityManager,
