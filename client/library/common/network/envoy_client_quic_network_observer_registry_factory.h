...
class EnvoyClientQuicNetworkObserverRegistry : public EnvoyQuicNetworkObserverRegistry {
public:
  EnvoyClientQuicNetworkObserverRegistry(Event::Dispatcher& dispatcher,
...
class EnvoyClientQuicNetworkObserverRegistryFactory
    : public EnvoyQuicNetworkObserverRegistryFactory {
public:
  explicit EnvoyClientQuicNetworkObserverRegistryFactory(
      NetworkConnectivityTracker& network_tracker);
...
using EnvoyClientQuicNetworkObserverRegistryPtr =
    std::unique_ptr<EnvoyClientQuicNetworkObserverRegistry>;
