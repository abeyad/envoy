package io.envoyproxy.envoyclient.utilities;
...
import io.envoyproxy.envoyclient.engine.AndroidNetworkMonitorV2;
import io.envoyproxy.envoyclient.engine.types.NetworkWithType;
...
public final class AndroidNetworkLibrary {
  ...
  public static long getDefaultNetworkHandle() {
    if (io.envoyproxy.envoyclient.engine.AndroidNetworkMonitorV2.getInstance() == null) {
      return -1;
    }
    return io.envoyproxy.envoyclient.engine.AndroidNetworkMonitorV2.getInstance().getDefaultNetId();
  }
  ...
  public static long[][] getAllConnectedNetworks() {
    ...
    NetworkWithType[] networks =
        io.envoyproxy.envoyclient.engine.AndroidNetworkMonitorV2.getInstance()
