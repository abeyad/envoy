...
import io.envoyproxy.envoyclient.engine.AndroidNetworkMonitor;
import io.envoyproxy.envoyclient.engine.UpstreamHttpProtocol;
import io.envoyproxy.envoyclient.engine.types.EnvoyFinalStreamIntel;
...
public class Errors {
   ...
   */
  @LongDef(flag = true,
           value = {EnvoyClientError.DNS_RESOLUTION_FAILED, EnvoyClientError.DURATION_TIMEOUT,
                    EnvoyClientError.STREAM_IDLE_TIMEOUT,
                    EnvoyClientError.UPSTREAM_CONNECTION_FAILURE,
                    EnvoyClientError.UPSTREAM_CONNECTION_TERMINATION,
                    EnvoyClientError.UPSTREAM_REMOTE_RESET})
  @Retention(RetentionPolicy.SOURCE)
  public @interface EnvoyClientError {
   ...
   * @param finalStreamIntel envoyclient's finalStreamIntel
   * @return the NetError that the EnvoyClientError maps to
   */
  public static NetError mapEnvoyClientErrorToNetError(EnvoyFinalStreamIntel finalStreamIntel) {
  ...
  private static Map<Long, NetError> buildErrorMap() {
    ...
    errorMap.put(EnvoyClientError.DNS_RESOLUTION_FAILED, NetError.ERR_NAME_NOT_RESOLVED);
    errorMap.put(EnvoyClientError.DURATION_TIMEOUT, NetError.ERR_TIMED_OUT);
    errorMap.put(EnvoyClientError.STREAM_IDLE_TIMEOUT, NetError.ERR_TIMED_OUT);
    errorMap.put(EnvoyClientError.UPSTREAM_CONNECTION_TERMINATION, NetError.ERR_CONNECTION_CLOSED);
    errorMap.put(EnvoyClientError.UPSTREAM_REMOTE_RESET, NetError.ERR_CONNECTION_RESET);
    errorMap.put(EnvoyClientError.UPSTREAM_CONNECTION_FAILURE, NetError.ERR_CONNECTION_REFUSED);
