...
using Envoy::Platform::ClientEngineBuilder;
...
Java_io_envoyproxy_envoyclient_engine_JniLibrary_setLogLevel(JNIEnv* /*env*/, jclass, jint level) {
  Envoy::Logger::Context::changeAllLogLevels(static_cast<spdlog::level::level_enum>(level));
}

extern "C" JNIEXPORT jlong JNICALL Java_io_envoyproxy_envoyclient_engine_JniLibrary_initEngine(
  ...
  if (on_engine_running != nullptr) {
    ...
    callbacks->on_engine_running_ = [on_engine_running_global_ref] {
      ...
      auto java_on_engine_running_class = jni_helper.findClassFromCache(
          "io/envoyproxy/envoyclient/engine/types/EnvoyOnEngineRunning");
  ...
  if (envoy_logger != nullptr) {
    ...
    logger->on_log_ = [envoy_logger_global_ref](Envoy::Logger::Logger::Levels level,
      ...
      auto java_envoy_logger_class =
          jni_helper.findClassFromCache("io/envoyproxy/envoyclient/engine/types/EnvoyLogger");
  ...
  if (envoy_event_tracker != nullptr) {
    ...
    event_tracker->on_track_ = [event_tracker_global_ref](
      ...
      auto java_envoy_event_tracker_class =
          jni_helper.findClassFromCache("io/envoyproxy/envoyclient/engine/types/EnvoyEventTracker");
...
extern "C" JNIEXPORT jint JNICALL Java_io_envoyproxy_envoyclient_engine_JniLibrary_runEngine(
...
extern "C" JNIEXPORT void JNICALL Java_io_envoyproxy_envoyclient_engine_JniLibrary_terminateEngine(
...
Java_io_envoyproxy_envoyclient_engine_JniLibrary_runtimeFeatureEnabled(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT jint JNICALL Java_io_envoyproxy_envoyclient_engine_JniLibrary_recordCounterInc(
    JNIEnv* env,
    jclass, // class
...
Java_io_envoyproxy_envoyclient_engine_JniLibrary_dumpStats(JNIEnv* env,
                                                           jclass, // class
                                                           jlong engine_handle) {
...
extern "C" JNIEXPORT void JNICALL
Java_io_envoyproxy_envoyclient_engine_JniLibrary_drainConnectionsBySocketTag(JNIEnv*, jclass,
                                                                             jlong engine_handle,
                                                                             jint tag) {
  auto engine = reinterpret_cast<Envoy::InternalEngine*>(engine_handle);
...
static const void* jvm_http_filter_init(const void* context) {
  ...
  jmethodID jmid_create =
      jni_helper.getMethodId(jcls_JvmFilterFactoryContext.get(), "create",
                             "()Lio/envoyproxy/envoyclient/engine/JvmFilterContext;");
...
extern "C" JNIEXPORT jlong JNICALL Java_io_envoyproxy_envoyclient_engine_JniLibrary_initStream(
    JNIEnv* /*env*/, jclass, jlong engine_handle) {
...
extern "C" JNIEXPORT jint JNICALL Java_io_envoyproxy_envoyclient_engine_JniLibrary_startStream(
  ...
  stream_callbacks.on_headers_ = [java_stream_callbacks_global_ref](
    ...
    auto java_stream_callbacks_class =
        jni_helper.findClassFromCache("io/envoyproxy/envoyclient/engine/types/EnvoyHTTPCallbacks");
  ...
  stream_callbacks.on_complete_ = [java_stream_callbacks_global_ref](
    ...
    auto java_on_complete_method_id = jni_helper.getMethodIdFromCache(
        ...
        "(Lio/envoyproxy/envoyclient/engine/types/EnvoyStreamIntel;"
        "Lio/envoyproxy/envoyclient/engine/types/EnvoyFinalStreamIntel;)V");
  ...
  stream_callbacks.on_error_ = [java_stream_callbacks_global_ref](
    ...
    auto java_on_error_method_id = jni_helper.getMethodIdFromCache(
        ...
        "(ILjava/lang/String;ILio/envoyproxy/envoyclient/engine/types/EnvoyStreamIntel;"
        "Lio/envoyproxy/envoyclient/engine/types/EnvoyFinalStreamIntel;)V");
  ...
  stream_callbacks.on_send_window_available_ = [java_stream_callbacks_global_ref](
    ...
    auto java_on_send_window_available_method_id = jni_helper.getMethodIdFromCache(
        ...
        "(Lio/envoyproxy/envoyclient/engine/types/EnvoyStreamIntel;)V");
...
Java_io_envoyproxy_envoyclient_engine_JniLibrary_registerKeyValueStore(JNIEnv* env, jclass,
                                                                       jstring name,
                                                                       jobject j_context) {

  // TODO(goaway): The java context here leaks, but it's tied to the life of the engine.
  // This will need to be updated for https://github.com/envoyproxy/envoy-client/issues/332
...
extern "C" JNIEXPORT jint JNICALL
Java_io_envoyproxy_envoyclient_engine_JniLibrary_registerFilterFactory(JNIEnv* env, jclass,
                                                                       jstring filter_name,
                                                                       jobject j_context) {
...
extern "C" JNIEXPORT void JNICALL
Java_io_envoyproxy_envoyclient_engine_EnvoyHTTPFilterCallbacksImpl_callResumeIteration(
...
extern "C" JNIEXPORT void JNICALL
Java_io_envoyproxy_envoyclient_engine_EnvoyHTTPFilterCallbacksImpl_callResetIdleTimer(
    JNIEnv* env, jclass, jlong callback_handle, jobject j_context) {
  // Context is only passed here to ensure it's not inadvertently gc'd during execution of this
  // function. To be extra safe, do an explicit retain with a GlobalRef.
  jobject retained_context = env->NewGlobalRef(j_context);
...
extern "C" JNIEXPORT void JNICALL
Java_io_envoyproxy_envoyclient_engine_EnvoyHTTPFilterCallbacksImpl_callReleaseCallbacks(
...
extern "C" JNIEXPORT jint JNICALL Java_io_envoyproxy_envoyclient_engine_JniLibrary_readData(
...
// heap) ByteBuffer.
extern "C" JNIEXPORT jint JNICALL Java_io_envoyproxy_envoyclient_engine_JniLibrary_sendData(
...
extern "C" JNIEXPORT jint JNICALL Java_io_envoyproxy_envoyclient_engine_JniLibrary_sendHeaders(
...
extern "C" JNIEXPORT jint JNICALL Java_io_envoyproxy_envoyclient_engine_JniLibrary_sendTrailers(
...
extern "C" JNIEXPORT jint JNICALL Java_io_envoyproxy_envoyclient_engine_JniLibrary_resetStream(
...
extern "C" JNIEXPORT jint JNICALL
Java_io_envoyproxy_envoyclient_engine_JniLibrary_registerStringAccessor(JNIEnv* env, jclass,
...
// setter on it.
void setString(Envoy::JNI::JniHelper& jni_helper, jstring java_string, ClientEngineBuilder* builder,
               ClientEngineBuilder& (ClientEngineBuilder::*setter)(std::string)) {
  if (!java_string) {
    return;
  }
  Envoy::JNI::StringUtfUniquePtr native_java_string =
...
void configureBuilder(
    ...
    jlong max_time_on_non_default_network_seconds, ClientEngineBuilder& builder) {
  ...
  setString(jni_helper, app_version, &builder, &ClientEngineBuilder::setAppVersion);
  setString(jni_helper, app_id, &builder, &ClientEngineBuilder::setAppId);
...
extern "C" JNIEXPORT jstring JNICALL
Java_io_envoyproxy_envoyclient_engine_JniLibrary_getNativeFilterConfig(JNIEnv* env, jclass,
                                                                       jstring filter_name_jstr) {
  Envoy::JNI::JniHelper jni_helper(env);
  std::string filter_name = Envoy::JNI::javaStringToCppString(jni_helper, filter_name_jstr);
  std::string filter_config = ClientEngineBuilder::nativeNameToConfig(filter_name);

  return jni_helper.newStringUtf(filter_config.c_str()).release();
}

extern "C" JNIEXPORT jlong JNICALL Java_io_envoyproxy_envoyclient_engine_JniLibrary_createBootstrap(
...
extern "C" JNIEXPORT jint JNICALL
Java_io_envoyproxy_envoyclient_engine_JniLibrary_resetConnectivityState(JNIEnv* /*env*/,
                                                                        jclass, // class
                                                                        jlong engine) {
...
extern "C" JNIEXPORT void JNICALL
Java_io_envoyproxy_envoyclient_engine_JniLibrary_onDefaultNetworkAvailable(JNIEnv*, jclass,
                                                                           jlong engine) {
  reinterpret_cast<Envoy::InternalEngine*>(engine)->onDefaultNetworkAvailable();
}

extern "C" JNIEXPORT void JNICALL
Java_io_envoyproxy_envoyclient_engine_JniLibrary_onDefaultNetworkChanged(JNIEnv*, jclass,
                                                                         jlong engine,
                                                                         jint network_type) {
...
extern "C" JNIEXPORT void JNICALL
Java_io_envoyproxy_envoyclient_engine_JniLibrary_onDefaultNetworkChangeEvent(JNIEnv*, jclass,
                                                                             jlong engine,
                                                                             jint network_type) {
...
extern "C" JNIEXPORT void JNICALL
Java_io_envoyproxy_envoyclient_engine_JniLibrary_onDefaultNetworkChangedV2(JNIEnv*, jclass,
                                                                           jlong engine,
...
extern "C" JNIEXPORT void JNICALL
Java_io_envoyproxy_envoyclient_engine_JniLibrary_onNetworkDisconnect(JNIEnv*, jclass, jlong engine,
                                                                     jlong net_id) {
  reinterpret_cast<Envoy::InternalEngine*>(engine)->onNetworkDisconnectAndroid(net_id);
}

extern "C" JNIEXPORT void JNICALL Java_io_envoyproxy_envoyclient_engine_JniLibrary_onNetworkConnect(
...
extern "C" JNIEXPORT void JNICALL
Java_io_envoyproxy_envoyclient_engine_JniLibrary_purgeActiveNetworkList(JNIEnv* env, jclass,
                                                                        jlong engine,
...
extern "C" JNIEXPORT void JNICALL
Java_io_envoyproxy_envoyclient_engine_JniLibrary_onDefaultNetworkUnavailable(JNIEnv*, jclass,
                                                                             jlong engine) {
  reinterpret_cast<Envoy::InternalEngine*>(engine)->onDefaultNetworkUnavailable();
}

extern "C" JNIEXPORT jint JNICALL Java_io_envoyproxy_envoyclient_engine_JniLibrary_setProxySettings(
    JNIEnv* env,
    jclass, // class
...
Java_io_envoyproxy_envoyclient_engine_JniLibrary_callCertificateVerificationFromNative(
...
extern "C" JNIEXPORT void JNICALL
Java_io_envoyproxy_envoyclient_engine_JniLibrary_callAddTestRootCertificateFromNative(
  ...
  jclass java_android_network_library_class =
      jni_helper.findClassFromCache("io/envoyproxy/envoyclient/utilities/AndroidNetworkLibrary");
...
extern "C" JNIEXPORT void JNICALL
Java_io_envoyproxy_envoyclient_engine_JniLibrary_callClearTestRootCertificateFromNative(JNIEnv*,
                                                                                        jclass) {
  Envoy::JNI::JniHelper jni_helper(Envoy::JNI::JniHelper::getThreadLocalEnv());
  jclass java_android_network_library_class =
      jni_helper.findClassFromCache("io/envoyproxy/envoyclient/utilities/AndroidNetworkLibrary");
...
Java_io_envoyproxy_envoyclient_engine_JniLibrary_callGetDefaultNetworkHandleFromNative(JNIEnv*,
                                                                                       jclass) {
  return Envoy::JNI::getDefaultNetworkHandle();
}

extern "C" JNIEXPORT jobjectArray JNICALL
Java_io_envoyproxy_envoyclient_engine_JniLibrary_callGetAllConnectedNetworksFromNative(JNIEnv* env,
                                                                                       jclass) {
  Envoy::JNI::JniHelper jni_helper(env);
