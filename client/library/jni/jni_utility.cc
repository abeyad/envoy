...
void JniUtility::initCache() {
  ...
  Envoy::JNI::JniHelper::addToCache(
      ...
      /* static_methods = */ {}, /* fields= */ {}, /* static_fields= */ {});
  Envoy::JNI::JniHelper::addToCache("io/envoyproxy/envoyclient/engine/types/EnvoyStreamIntel",
                                    /* methods= */
                                    {
                                        {"<init>", "(JJJJ)V"},
                                        {"getStreamId", "()J"},
                                    ...
                                    /* static_methods = */ {}, /* fields= */ {},
                                    /* static_fields= */ {});
  Envoy::JNI::JniHelper::addToCache("io/envoyproxy/envoyclient/engine/types/EnvoyFinalStreamIntel",
                                    /* methods= */
                                    {
...
envoy_stream_intel javaStreamIntelToCppStreamIntel(JniHelper& jni_helper,
  ...
  auto java_stream_intel_class =
      jni_helper.findClassFromCache("io/envoyproxy/envoyclient/engine/types/EnvoyStreamIntel");
...
javaFinalStreamIntelToCppFinalStreamIntel(JniHelper& jni_helper, jobject java_final_stream_intel) {
  auto java_final_stream_intel_class =
      jni_helper.findClassFromCache("io/envoyproxy/envoyclient/engine/types/EnvoyFinalStreamIntel");
