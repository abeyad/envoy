...
/**
 * Converts from Java `io.envoyproxy.envoyclient.engine.types.EnvoyStreamIntel` to C++
 * `envoy_stream_intel`.
 */
 ...
 * `io.envoyproxy.envoyclient.engine.types.EnvoyStreamIntel`.
 */
LocalRefUniquePtr<jobject> cppStreamIntelToJavaStreamIntel(JniHelper& jni_helper,
                                                           const envoy_stream_intel& stream_intel);

/**
 * Converts from Java `io.envoyproxy.envoyclient.engine.types.EnvoyFinalStreamIntel` to C++
 ...
 * `io.envoyproxy.envoyclient.engine.types.EnvoyFinalStreamIntel`.
 */
