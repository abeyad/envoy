"""Async httpx transport for Envoy Client."""
...
class AsyncEnvoyClientTransport(httpx.AsyncBaseTransport):
    """An asynchronous transport for httpx that uses Envoy Client."""
    ...
    async def handle_async_request(self, request: httpx.Request) -> httpx.Response:
        ...
        # non-blocking calls that interface directly with the Envoy Client C++ engine.
