...
public:
  void setUpFilter(std::string&& proto_str) {
    envoyclient::extensions::filters::http::assertion::Assertion config;
...
TEST(AssertionFilterFactoryTest, Config) {
  ...
  envoyclient::extensions::filters::http::assertion::Assertion proto_config =
      *dynamic_cast<envoyclient::extensions::filters::http::assertion::Assertion*>(
