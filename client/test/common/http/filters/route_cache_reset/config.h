...
class RouteCacheResetFilterFactory
    : public Common::FactoryBase<
          envoyclient::extensions::filters::http::route_cache_reset::RouteCacheReset> {
public:
  RouteCacheResetFilterFactory() : FactoryBase("route_cache_reset") {}

private:
  ::Envoy::Http::FilterFactoryCb createFilterFactoryFromProtoTyped(
      const envoyclient::extensions::filters::http::route_cache_reset::RouteCacheReset& config,
