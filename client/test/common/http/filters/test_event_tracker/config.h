...
class TestEventTrackerFilterFactory
    : public Common::FactoryBase<
          envoyclient::extensions::filters::http::test_event_tracker::TestEventTracker> {
public:
  TestEventTrackerFilterFactory() : FactoryBase("test_event_tracker") {}

private:
  ::Envoy::Http::FilterFactoryCb createFilterFactoryFromProtoTyped(
      const envoyclient::extensions::filters::http::test_event_tracker::TestEventTracker& config,
