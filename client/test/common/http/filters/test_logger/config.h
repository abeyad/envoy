 ...
 */
class Factory
    : public Common::FactoryBase<envoyclient::extensions::filters::http::test_logger::TestLogger> {
public:
  Factory() : FactoryBase("test_logger") {}

private:
  Envoy::Http::FilterFactoryCb createFilterFactoryFromProtoTyped(
      const envoyclient::extensions::filters::http::test_logger::TestLogger& config,
