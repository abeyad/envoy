...
class TestRemoteResponseFilterFactory
    : public Common::FactoryBase<
          envoyclient::extensions::filters::http::test_remote_response::TestRemoteResponse> {
public:
  TestRemoteResponseFilterFactory() : FactoryBase("test_remote_response") {}

private:
  ::Envoy::Http::FilterFactoryCb createFilterFactoryFromProtoTyped(
      const envoyclient::extensions::filters::http::test_remote_response::TestRemoteResponse&
          config,
