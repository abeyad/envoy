...
protected:
  ...
  void setUpSdsConfig(envoy::extensions::transport_sockets::tls::v3::SdsSecretConfig* secret_config,
    ...
    // Envoy Client only supports SDS with ADS.
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Combine(testing::ValuesIn(TestEnvironment::getIpVersionsForTest()),
                     ...
                     // Envoy Client's xDS APIs only support state-of-the-world, not delta.
                     testing::Values(Grpc::SotwOrDelta::Sotw, Grpc::SotwOrDelta::UnifiedSotw)));

// Note: Envoy Client does not have listener sockets, so we aren't including a downstream test.
