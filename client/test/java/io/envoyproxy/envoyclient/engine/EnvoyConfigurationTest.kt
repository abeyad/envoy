...
import io.envoyproxy.envoyclient.engine.types.EnvoyHTTPFilter
import io.envoyproxy.envoyclient.engine.types.EnvoyHTTPFilterFactory
import io.envoyproxy.envoyclient.engine.EnvoyConfiguration.TrustChainVerification
...
import io.envoyproxy.envoyclient.engine.testing.TestJni
...
class EnvoyConfigurationTest {
  ...
  fun `configuration default values`() {
    ...
    assertThat(resolvedTemplate).contains("type.googleapis.com/envoy_client.extensions.quic_packet_writer.platform.QuicPlatformPacketWriterConfig")
