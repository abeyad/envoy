package io.envoyproxy.envoyclient.jni;
...
public class JniHelperTest {
  ...
  public void testGetFieldIdFromCache() {
    ...
    for (int i = 0; i < 10; i++) {
      getFieldIdFromCache("io/envoyproxy/envoyclient/jni/JniHelperTest$Foo", "field", "I");
    }
  }
  ...
  public void testGetStaticFieldIdFromCache() {
    // Do it in a loop to test the cache.
    for (int i = 0; i < 10; i++) {
      getStaticFieldIdFromCache("io/envoyproxy/envoyclient/jni/JniHelperTest$Foo", "staticField",
                                "I");
    }
  }
  ...
  public void testGetMethodIdFromCache() {
    // Do it in a loop to test the cache.
    for (int i = 0; i < 10; i++) {
      getMethodIdFromCache("io/envoyproxy/envoyclient/jni/JniHelperTest$Foo", "<init>", "()V");
    }
  }
  ...
  public void testGetStaticMethodIdFromCache() {
    // Do it in a loop to test the cache.
    for (int i = 0; i < 10; i++) {
      getStaticMethodIdFromCache("io/envoyproxy/envoyclient/jni/JniHelperTest$Foo", "staticMethod",
                                 "()V");
    }
  }
