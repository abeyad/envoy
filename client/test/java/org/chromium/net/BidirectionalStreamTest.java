...
public class BidirectionalStreamTest {
  ...
  public void testSimpleGetBufferUpdates() throws Exception {
    ...
    // TODO(https://github.com/envoyproxy/envoy-client/issues/2265): fix expected ReceivedByteCount
    // runSimpleGetWithExpectedReceivedByteCount(27);
  }
  ...
  private void throwOrCancel(FailureType failureType, ResponseStep failureStep,
    ...
    if (failureStep == ResponseStep.ON_RESPONSE_STARTED ||
      ...
      // TODO(https://github.com/envoyproxy/envoy-client/issues/2192): flaky.
  ...
  public void testFailures() throws Exception {
    // TODO(https://github.com/envoyproxy/envoy-client/issues/2192): start/end time are not set.
    ...
    // TODO(https://github.com/envoyproxy/envoy-client/issues/2192): start/end time are flaky.
