...
import org.chromium.net.impl.Errors.EnvoyClientError;
...
public class CronetUrlRequestTest {
  ...
  @SmallTest
  @Feature({"Cronet"})
  @Ignore("https://github.com/envoyproxy/envoy-client/issues/1522")
  ...
  @SmallTest
  @Feature({"Cronet"})
  @Ignore("https://github.com/envoyproxy/envoy-client/issues/1550")
  ...
  @SmallTest
  @Feature({"Cronet"})
  @Ignore("https://github.com/envoyproxy/envoy-client/issues/1551")
  ...
  @SmallTest
  @Feature({"Cronet"})
  @Ignore("https://github.com/envoyproxy/envoy-client/issues/1549")
  ...
  public void testErrorCodes() throws Exception {
    ...
    checkSpecificErrorCode(EnvoyClientError.UPSTREAM_REMOTE_RESET, NetError.ERR_CONNECTION_RESET,
                           NetworkException.ERROR_CONNECTION_RESET, "CONNECTION_RESET", true,
                           /*error_details=*/"rc: 400|ec: 0|rsp_flags: 4|http: 1");
    checkSpecificErrorCode(EnvoyClientError.STREAM_IDLE_TIMEOUT, NetError.ERR_TIMED_OUT,
  ...
  public void testInternetDisconnectedError() throws Exception {
    ...
    checkSpecificErrorCode(
        EnvoyClientError.DNS_RESOLUTION_FAILED, NetError.ERR_INTERNET_DISCONNECTED,
  ...
  private void checkSpecificErrorCode(@EnvoyClientError long envoyMobileError, NetError netError,
  ...
  @Ignore("https://github.com/envoyproxy/envoy-client/issues/1521")
