...
import static org.chromium.net.impl.Errors.mapEnvoyClientErrorToNetError;
...
public class ErrorsTest {
  ...
  @Test
  public void testMapEnvoyClientErrorToInternetDisconnected() {
    ...
    NetError error = mapEnvoyClientErrorToNetError(intel);
    assertEquals(NetError.ERR_INTERNET_DISCONNECTED, error);
  }

  @Test
  public void testMapEnvoyClientErrorToNetErrorHttp3() throws Exception {
  ...
  @Test
  public void testMapEnvoyClientErrorToNetErrorFoundInMap() throws Exception {
  ...
  @Test
  public void testMapEnvoyClientErrorToNetErrorFoundInMapOnHttp3() throws Exception {
    // 4 corresponds to UpstreamRemoteReset in StreamInfo::CoreResponseFlag:
    // https://github.com/envoyproxy/envoy/blob/410e9a77bd6b74abb3e1545b4fd077e734d0fce3/envoy/stream_info/stream_info.h#L39
    long responseFlags = 1L << 4;
    EnvoyFinalStreamIntel intel = constructStreamIntel(responseFlags, UpstreamHttpProtocol.HTTP3);
  ...
  @Test
  public void testMapEnvoyClientErrorToNetErrorMultipleResponseFlags() throws Exception {
  ...
  @Test
  public void testMapEnvoyClientErrorToNetErrorNotFoundInMap() throws Exception {
  ...
  @Test
  public void testMapEnvoyClientErrorToNetErrorEmptyResponseFlags() throws Exception {
