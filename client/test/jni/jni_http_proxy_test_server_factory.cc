...
extern "C" JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* /* reserved */) {
  ...
  Envoy::JNI::JniHelper::addToCache(
      "io/envoyproxy/envoyclient/engine/testing/HttpProxyTestServerFactory$HttpProxyTestServer",
      /* methods= */
      {
...
Java_io_envoyproxy_envoyclient_engine_testing_HttpProxyTestServerFactory_start(JNIEnv* env, jclass,
                                                                               jint type) {
...
Java_io_envoyproxy_envoyclient_engine_testing_HttpProxyTestServerFactory_00024HttpProxyTestServer_shutdown(
