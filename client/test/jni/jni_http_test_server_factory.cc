...
extern "C" JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* /* reserved */) {
  ...
  Envoy::JNI::JniHelper::addToCache(
      "io/envoyproxy/envoyclient/engine/testing/HttpTestServerFactory$HttpTestServer",
      /* methods= */
      {
...
Java_io_envoyproxy_envoyclient_engine_testing_HttpTestServerFactory_start(
...
Java_io_envoyproxy_envoyclient_engine_testing_HttpTestServerFactory_00024HttpTestServer_shutdown(
