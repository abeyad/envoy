...
// `test/java/io/envoyproxy/envoyclient/jni/JniUtilityTest.java` unit tests.
...
Java_io_envoyproxy_envoyclient_jni_JniUtilityTest_protoJavaByteArrayConversion(JNIEnv* env, jclass,
                                                                               jbyteArray source) {
...
Java_io_envoyproxy_envoyclient_jni_JniUtilityTest_javaCppStringConversion(JNIEnv* env, jclass,
                                                                          jstring java_string) {
  Envoy::JNI::JniHelper jni_helper(env);
...
Java_io_envoyproxy_envoyclient_jni_JniUtilityTest_javaCppMapConversion(JNIEnv* env, jclass,
                                                                       jobject java_map) {
  Envoy::JNI::JniHelper jni_helper(env);
...
extern "C" JNIEXPORT jobject JNICALL
Java_io_envoyproxy_envoyclient_jni_JniUtilityTest_javaCppHeadersConversion(JNIEnv* env, jclass,
...
Java_io_envoyproxy_envoyclient_jni_JniUtilityTest_isJavaDirectByteBuffer(JNIEnv* env, jclass,
...
extern "C" JNIEXPORT jobject JNICALL
Java_io_envoyproxy_envoyclient_jni_JniUtilityTest_javaCppDirectByteBufferConversion(
...
extern "C" JNIEXPORT jobject JNICALL
Java_io_envoyproxy_envoyclient_jni_JniUtilityTest_javaCppNonDirectByteBufferConversion(
    JNIEnv* env, jclass, jobject java_byte_buffer, jlong length) {
  Envoy::JNI::JniHelper jni_helper(env);
  auto cpp_buffer_instance =
...
extern "C" JNIEXPORT jstring JNICALL
Java_io_envoyproxy_envoyclient_jni_JniUtilityTest_getJavaExceptionMessage(JNIEnv* env, jclass,
                                                                          jthrowable throwble) {
  Envoy::JNI::JniHelper jni_helper(env);
...
extern "C" JNIEXPORT jobject JNICALL
Java_io_envoyproxy_envoyclient_jni_JniUtilityTest_javaCppStreamIntelConversion(
...
extern "C" JNIEXPORT jobject JNICALL
Java_io_envoyproxy_envoyclient_jni_JniUtilityTest_javaCppFinalStreamIntelConversion(
