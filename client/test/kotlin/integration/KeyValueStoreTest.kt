...
import envoyclient.extensions.filters.http.test_kv_store.Filter.TestKeyValueStore
import io.envoyproxy.envoyclient.EngineBuilder
import io.envoyproxy.envoyclient.KeyValueStore
...
class KeyValueStoreTest {
  ...
  fun `a registered KeyValueStore implementation handles calls from a TestKeyValueStore filter`() {
    ...
    var anyProto =
      Any.newBuilder()
        .setTypeUrl(
          "type.googleapis.com/envoyclient.extensions.filters.http.test_kv_store.TestKeyValueStore"
        )
