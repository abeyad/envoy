...
import envoyclient.extensions.filters.http.assertion.Filter.Assertion
...
class SendDataTest {
  ...
  fun `successful sending data`() {
    ...
    var anyProto =
      Any.newBuilder()
        .setTypeUrl("type.googleapis.com/envoyclient.extensions.filters.http.assertion.Assertion")
    ...
    client
      ...
      .setOnResponseData { _, endStream, _ ->
        // Sometimes Envoy Client may send an empty data (0 byte) with `endStream` set to true
