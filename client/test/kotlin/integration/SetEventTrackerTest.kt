...
import envoyclient.extensions.filters.http.test_event_tracker.Filter.TestEventTracker
...
class SetEventTrackerTest {
  ...
  fun `set eventTracker`() {
    ...
    var anyProto =
      Any.newBuilder()
        .setTypeUrl(
          "type.googleapis.com/envoyclient.extensions.filters.http.test_event_tracker.TestEventTracker"
        )
