...
import envoyclient.extensions.filters.http.test_logger.Filter.TestLogger
...
class SetLoggerTest {
  ...
  fun `set logger`() {
    ...
    var anyProto =
      Any.newBuilder()
        .setTypeUrl(
          "type.googleapis.com/envoyclient.extensions.filters.http.test_logger.TestLogger"
        )
