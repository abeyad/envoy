...
# the correct envoy-client Bazel targets.

# Setting TEST_TMPDIR here so the compdb headers won't be overwritten by another bazel run
CC=clang TEST_TMPDIR=${BUILD_DIR:-/tmp}/envoy-client-compdb ../tools/gen_compilation_database.py --vscode --bazel bazel //library/cc/... //library/common/... //test/cc/... //test/common/...
