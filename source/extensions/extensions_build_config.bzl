...
EXTENSION_CONFIG_VISIBILITY = ["//:extension_config", "//:contrib_library", "//:client_library"]
EXTENSION_PACKAGE_VISIBILITY = ["//:extension_library", "//:contrib_library", "//:client_library"]
